...
android {
    namespace = "com.example.focustodo"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.focustodo"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Room Database for local data storage (Mocking backend logic locally)
    implementation("androidx.room:room-runtime:2.6.1")
    implementation("androidx.room:room-ktx:2.6.1")
    kapt("androidx.room:room-compiler:2.6.1")

    // Retrofit for future API connection
